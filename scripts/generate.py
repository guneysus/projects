...
def page_rel_path(project):
    ...
    folder = "forks" if project.get("fork") else "projects"
    return f"{folder}/{slugify(project['name'])}.md"
...
def build_project_page(project, duplicates):
    ...
    lines.append("---")
    lines.append("")
    back = "../README.md" if project.get("fork") else "../README.md"
...
def main():
    ...
    for p in projects:
        ...
        folder = FORKS_DIR if p.get("fork") else PROJECTS_DIR
